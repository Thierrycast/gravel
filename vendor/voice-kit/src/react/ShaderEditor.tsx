...
import { ShaderVisual, shadersAvailable } from "../visuals/gl-visual";
import { MotionState } from "../core/motion-tokens";
import { VoiceVisualMetrics } from "../core/audio-metrics";
import { CUSTOM_STARTER } from "../visuals/voice-visuals";
...
Enquanto não compilar, o visual anterior continua valendo — nada é gravado.</pre>}
        <button className="secondary-button" type="button" onClick={restaurar}><ResetIcon size={14} /> Restaurar o exemplo</button>
      </div>
    </div>
