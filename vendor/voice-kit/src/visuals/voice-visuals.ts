...
import { ParticleOrbRenderer } from "./orb-renderer";
...
export const VISUALS: VisualEntry[] = [
  {
    ...
    description: "Luz percorrendo a borda da tela. Não desenha um objeto: acende a moldura.",
  ...
  },
  {
    id: "mesh-field",
    name: "02 · Mesh Field",
    description: "Campo de cor que se move devagar atrás do conteúdo.",
  ...
  },
  {
    id: "soft-orb",
    name: "03 · Soft Orb",
    description: "Uma esfera só, deformada por ruído, com brilho interno.",
  ...
  {
    id: "particle-orb",
    name: "00 · Orb de partículas",
    description: "Canvas 2D, sem WebGL. Serve de reserva quando o shader não sobe.",
    technique: "canvas 2D · 72 partículas orbitais",
    webgl: false,
    create: (canvas, options) => new ParticleOrbRenderer(canvas, { color: options.signal, reducedMotion: options.reducedMotion }),
  },
  {
    id: "custom",
    name: "06 · Seu shader",
    description: "O visual que você escrever. Entregue o código em `setCustomShader`.",
